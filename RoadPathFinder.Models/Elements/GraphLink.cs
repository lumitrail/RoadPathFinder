...
namespace RoadPathFinder.Models.Elements
{
    ...
    public class GraphLink
    {
        ...
        public IReadOnlyDictionary<string, EDirection> StartNodeConnectedLinkIDs => _startNodeConnectedLinkIDs;
        /// <summary>
        /// start node를 통해 진출할 수 있는 link들의 ID
        /// </summary>
        /// <remarks>value: 연결된 링크로 진출했을 때, 진행 방향</remarks>
        private ConcurrentDictionary<string, EDirection> _startNodeConnectedLinkIDs { get; } = new();
        ...
        public IReadOnlyDictionary<string, EDirection> EndNodeConnectedLinkIDs => _endNodeConnectedLinkIDs;
        /// <summary>
        /// end node를 통해 진출할 수 있는 link들의 id
        /// </summary>
        /// <remarks>value: 연결된 링크로 진출했을 때, 진행 방향</remarks>
        private ConcurrentDictionary<string, EDirection> _endNodeConnectedLinkIDs { get; } = new();
